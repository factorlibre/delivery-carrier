...
<div id="box">
  ...
  <!--Logo-->
  <div id="logo">
    <img src="https://express.tnt.com/expresslabel-website/rendering/images/logo_orig.jpg" alt='logo' id="tntLogo" />
  </div>
  ...
  <div id="barcode" name="barcode">
    <img>
       <xsl:attribute name="src">
         <xsl:value-of select="concat('https://express.tnt.com/barbecue/barcode?type=Code128C&amp;height=140&amp;width=2&amp;data=',barcode)" />
       </xsl:attribute> 
    </img>
  </div>
  <div id="barcodeLabel">
